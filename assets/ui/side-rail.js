...
(function(){
  const LINKS = [
    {
      href: "/hr_attrition_dashboard_lite.html",
    ...
    {
      href: "/predictive_attrition_case_study.html",
      label: "Predictive Case Study",
    ...
    {
      href: "/recruitment_case_study.html",
      label: "Recruitment Case Study",
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    // Active state by path (loose match so /page#hash also works)
